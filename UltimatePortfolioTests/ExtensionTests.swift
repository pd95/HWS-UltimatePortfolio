...
class ExtensionTests: XCTestCase {
    ...
    func testSequenceKeyPathSortingCustom() {
        ...
        // Then
        XCTAssertEqual(sortedItems, [example3, example2, example1], "The sorted structs must be in descending order.")
    }
    ...
    func testBindingOnChange() {
        ...
        XCTAssertEqual(storedValue, "Test", "Stored value should have changed to 'Test'")
    }
}
